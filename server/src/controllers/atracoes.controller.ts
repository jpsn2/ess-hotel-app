...
export class atracoesController {
    atracoes: Atracao[];
    ...
    getAllAtracoes(): Atracao[] {
        return this.atracoes;
    }

    getAtracaoByID(atracaoId: string): Atracao {

        let atracao: Atracao = this.atracoes[5];
